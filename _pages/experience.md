...
I attended the 2025 S.-T. Yau College Student Mathematics Contest and eventually obtained **Honorable Mention in Written Exam** on Analysis and Partial Differential Equations.

I gave a **lecture on mathematical analysis** to the freshman majoring in mathematics in the first semester (c.f. [talks](/talks)). During the winter vacation, I organized a **seminar on smooth manifolds** and gave 2 lectures "Revision of Topological Manifolds" and "Tangent Space of Smooth Manifolds" by myself. In the second semester, I will attend the **seminar on representation theory** under the guidance of **[Prof. Shucheng YU](https://sites.google.com/site/shuchengyu126/)** and will give 3 lecture, introducing Representations, Maschke’s Theorem, Semisimplicity and The Structure of Algebras for WhichEvery Module Is
Semisimple based on the textbook P. WEBB _A Course in Finite Group Representation Theory_.
